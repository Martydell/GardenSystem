...
export const AREAS = [
  ...
  {key:'courtyard',     group:'outdoor',    label:'Courtyard',          icon:'&#x2600;&#xFE0F;', cols:14,rows:8, size:76, zones:COURTYARD_ZONES, defaultPos:COURTYARD_DEFAULT, defaultText:COURTYARD_TEXT, defaultObjects:COURTYARD_DEFAULT_OBJECTS, defaultFilter:'outdoor'},
