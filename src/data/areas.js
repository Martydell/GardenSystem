import { COURTYARD_DEFAULT, COURTYARD_TEXT, COURTYARD_ZONES, GREENHOUSE_DEFAULT, GREENHOUSE_ZONES, INDOOR_ZONES } from './zones.js';
...
export const AREAS = [
  ...
  {key:'hydrostart', label:'Hydroponics Starter',icon:'&#x1F331;', cols:6, rows:4, size:72, zones:null,             defaultFilter:'hydro'},
